...
import Application.validacao.ValidacaoAtualizar;
...
public class Atualizar extends javax.swing.JFrame {
    ...
    private void btnConfirmarAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarAtualizarActionPerformed
        ...
        if(ValidacaoAtualizar.validarAtualizar(id, nome, telefone, endereco, necessidades, status, cep)){
    ...
    private void txtIdAtualizarActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try (Connection conn = ConexaoBD.obtemConexao();
            ...
            JOptionPane.showMessageDialog(null, "Falha ao buscar. Verifique o id colocado.", "Erro", JOptionPane.ERROR_MESSAGE);
            throw new RuntimeException(e);
        }
